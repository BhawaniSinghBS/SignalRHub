...
namespace TCP.UDP.TCP_UDPModals
{
    public class TCP_UDPFrameModal
    {
        public int Id
        {
            get
            {
                ...
                {
                    int messageId = BitConverter.ToInt32(this.FrameBytesWithStartStopBits, 2);// contains start and stop bits i.e byte.MaxValue
                    return messageId;
                }
                return -1;
            }
        ...
        public int MessageTypeReceivedId
        {
            get
            {
                if (IsCompleteFrame)// valid message will be greater than 10
                {
                    int messageId = (int)FrameBytesWithStartStopBits[1];// contains start and stop bits i.e byte.MaxValue at 0 at 1 type of message
                    return messageId;
                }
                return -1;
            }
        ...
        public bool IsCompleteFrame
        {
            get
            {
                ...
                {
                    iscompleteFrame = FrameBytesWithStartStopBits[0] == byte.MaxValue &&
